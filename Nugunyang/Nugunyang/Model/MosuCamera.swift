...
class MosuCamera: NSObject, ObservableObject {
...
extension MosuCamera: AVCapturePhotoCaptureDelegate {
...
extension MosuCamera: AVCaptureVideoDataOutputSampleBufferDelegate {
