...
//             */
//            let modelURL = Bundle.main.url(forResource: "MyCatImageClassifier", withExtension: "mlmodelc")!
//            let model = try VNCoreMLModel(for: MyCatImageClassifier(contentsOf: modelURL).model)
//            
